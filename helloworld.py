                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                ...
                                start = time.time()
                                client.sendMessage(to, "Sabar Sayang, Love You :*")
                                ...
                                client.sendMessage(to, "Love You :*")
                            elif cmd == "respon1":
                                client.sendMessage(to, "Hadir Kapten")
                            ...
                            for mention in mentionees:
                                if clientMid in mention["M"]:
                                    if settings["autoRespon"] == True:
                                        sendMention(sender, "Oi Asw @!,jangan main tag tag","Gelud sini kuuy @!,", [sender])
                                    break
            except Exception as error:
                logError(error)
                traceback.print_tb(error.__traceback__)
